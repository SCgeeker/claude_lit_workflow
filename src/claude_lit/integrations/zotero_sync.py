...
# 注意：庫模組不得在 import 時重新包裝 sys.stdout
...
try:
    ...
    from claude_lit.integrations.bibtex_parser import BibTeXParser, BibTeXEntry
    from claude_lit.integrations.zotero_scanner import ZoteroScanner, PDFFile
